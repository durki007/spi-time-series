...
\label{sec:ablation-classification}
...
\label{sec:ablation-regression}

A corresponding ablation for the regression task was not
performed. Given that time-series features degraded performance
for all prefix lengths (\autoref{sec:results-time}), the log-only
configuration was adopted without further feature group analysis.
The classification ablation confirms that the A+W configuration
generalises well and is used as the reference model for both tasks.
